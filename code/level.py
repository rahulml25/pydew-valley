...
class Level:
  ...
  def __init__(self):
    ...
    # music
    self.success = pygame.mixer.Sound(AUDIO_DIR / 'success.wav')
  ...
  def setup(self):
    tmx_data = load_pygame(BASE_DIR / 'data/map.tmx')
    ...
    # water
    water_frames = import_folder(GRAPHICS_DIR / 'water')
    ...
    Generic(
      pos=(0, 0),
      surf=pygame.image.load(GRAPHICS_DIR / 'world/ground.png').convert_alpha(),
    ...
    if self.soil_layer.plant_sprites:
      for plant in self.soil_layer.plant_sprites.sprites():
        if plant.harvestable and plant.rect.colliderect(self.player.hitbox):
          ...
          row, col = plant.rect.centery // TILE_SIZE, plant.rect.centerx // TILE_SIZE
